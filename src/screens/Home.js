...
const merchantname = 'Công ty cổ phần ACEXIS'
const merchantcode = 'MOMO1QWG20200311'
const merchantNameLabel = 'Nhà cung cấp'
const billdescription = 'Phí mở khóa tài khoản đặt cơm'
const amount = 69000
...
export default class Home extends Component {
	...
	componentDidMount() {
		...
		EventEmitter.addListener(
			...
			response => {
				console.log('1<MoMoPay>Listen.Event::' + JSON.stringify(response))
				try {
		...
		EventEmitter.addListener(
			...
			response => {
				console.log('2<MoMoPay>Listen.RequestTokenState:: ' + response.status)
	...
	onPress = async () => {
		if (!this.state.processing) {
			...
			jsonData.appScheme = 'momo1qwg20200311' // iOS App Only , get from Info.plist > key URL types > URL Schemes. Check Readme
